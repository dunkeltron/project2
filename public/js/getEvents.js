//$(document).on('ready', function () {
    var ajaxData;
    var userGeoHash;
    // Getting geohash from w3schools code
    ...
    function buildQueryURL() {
      ...
      //  TODO: Test Passing in geoPoint from geoHash
      queryParams.geoPoint = userGeoHash;//"c23nb62qp";
      queryParams.startDateTime = // ("2018-12-07T00:01:00Z")
      eventTime
      queryParams.endDateTime = //("2018-12-07T23:59:00Z")
      eventEnd
  
      queryParams.radius="1"
      queryParams.unit = "km"
      
     // ("2018-12-02T00:01:00Z")
